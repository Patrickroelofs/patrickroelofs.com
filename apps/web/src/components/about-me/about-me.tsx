...
function AboutMeSection() {
	return (
		<section className="px-s pt-3xl">
			<div className="relative mx-auto pb-20 flex max-w-6xl flex-col gap-6 px-4 pt-8 md:top-32 md:pb-32 md:px-0">
				...
				<ul className="grid grid-cols-1 gap-m md:grid-cols-2 md:gap-l">
					<li className="flex items-start justify-start gap-s">
						<div className="w-l h-l bg-redleather/30 rounded-full shrink-0 flex items-center justify-center">
						...
						<div className="flex flex-col gap-3xs">
							...
							<p>
								...
								undertake, creating engaging and delightful digital experiences.
							</p>
						</div>
					</li>
					...
					<li className="flex items-start justify-start gap-s">
						...
						<div className="flex flex-col gap-3xs">
							...
							<p>
								I optimize websites for speed and efficiency, ensuring fast load
								times and smooth interactions for an exceptional user
								experience.
							</p>
						</div>
					</li>
